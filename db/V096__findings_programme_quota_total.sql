-- ═══════════════════════════════════════════════════════════════════════════
-- V096 — the quota-total finding sums the PROGRAMME quotas, not the faculty ones
--
--   Quotas are distributed to each programme now, so the finding that checks the
--   distribution against the NUC approved quota must total the programme quotas
--   (admissions.programme_rule.quota), not the vestigial faculty quotas. The old
--   "Distributed 8000 of 11218" was summing admissions.faculty_quota — a table
--   no longer edited. Relabelled to name the programmes, and owned by the Heads
--   of Department who now distribute the places.
-- ═══════════════════════════════════════════════════════════════════════════
