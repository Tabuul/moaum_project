...
export interface AttachmentState {
  ...
  candidates: { id: string; jambKey: string; surname: string; otherNames: string; programme: string; entryMode: string; hasPassport: boolean; hasDob: boolean; hasOlevel: boolean }[];
}
