...
export const OFFICE_LABELS: Record<string, string> = {
  ...
  ict: "Director of ICT",
  ictagent: "ICT Support Agent",
  extexaminer: "External Examiner",
...
export const ROLE_LABELS: Record<string, [string, string]> = {
  ...
  ictagent: ["ICT Support Agent", "Directorate of ICT · support desk"],
  extexaminer: ["External Examiner", "Appointed from another institution"],
