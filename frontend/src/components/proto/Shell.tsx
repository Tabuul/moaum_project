...
const OVERRIDES: Record<string, [string, string]> = {
  ...
  "s/tickets": ["ICT Support", "Your tickets with the Directorate of ICT, and a new one"],
  "r/tickets": ["ICT Support", "Your tickets with the Directorate of ICT, and a new one"],
