...
export const ROUTES: Record<string, string> = {
  ...
  "t/sheethistory": "/results/sheets/history",
  "t/coursehistory": "/me/courses",
  "r/notices": "/me/notices",
  "t/myprofile": "/me/profile",
  "t/deptstaff": "/hod/staff",
  "t/matriculation": "/matriculation",
  "t/matriculation-config": "/matriculation/config",
  "t/matriculation-manage": "/matriculation/manage",
  "t/reports": "/reports",
  ...
  "t/collegepayments": "/college/payments",
  "t/session": "/calendar",
  "t/examsession": "/examinations/sessions",
  "t/clearance": "/clearance",
  "t/transcripts": "/credentials/transcripts",
  "t/documents": "/credentials/documents",
  "t/documents-requests": "/credentials/documents/requests",
  "t/documents-register": "/credentials/documents/register",
  "t/documents-settings": "/credentials/documents/settings",
  ...
  "s/pgprogress": "/student/pg-progress",
  ...
  "t/hostel": "/hostel",
  "t/hostel-window": "/hostel/window",
  "t/hostel-inventory": "/hostel/inventory",
  "t/hostel-applications": "/hostel/applications",
  "t/hostel-occupancy": "/hostel/occupancy",
  "t/hostel-clearance": "/hostel/clearance",
  ...
  "t/deferments": "/deferments",
  "s/deferment": "/student/deferment",
...
const OVERRIDES: Record<string, [string, string]> = {
  ...
  "s/pgprogress": ["Academic Progress", "Your coursework, research and each graduation requirement as the record answers it"],
  ...
  "t/deferments": ["Deferments", "Semesters and sessions deferred on the record: the requests, the desks, the returns"],
  "s/deferment": ["Deferment", "Defer a semester or a session, on the record"],
  "t/studentstats": ["Student Statistics", "Students in study, paid, registered, paid not registered and not paid — by faculty, department and programme"],
  ...
  "r/lecturer": ["Lecturer Dashboard", "Your courses, score sheets, students and notices this session"],
  "t/sheethistory": ["Score Sheet History", "Every sheet you have carried, across sessions"],
  "t/coursehistory": ["Course History", "Every course allocated to you, and the class each one had"],
  "r/notices": ["Notifications", "What the portal has sent you"],
  "t/myprofile": ["My Profile", "Your record as the University holds it — and what you may change"],
  ...
  "t/collegepayments": ["Student Payment Report", "Every College student's fees position, by session or by semester"],
