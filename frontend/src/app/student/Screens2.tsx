...
import type { Fees, Me, Receipt } from "@/lib/student-portal";
        ...
        <Panel title="Pay" right="Against a reference this portal generates">
          <PBody>
            {open ? (
              ...
              <>
                <div className="sub2">Pay the balance, or part of it. Half the charge is the first instalment.</div>
                <div style={{ display: "flex", gap: 9, flexWrap: "wrap", alignItems: "center" }}>
                  ...
                  <Btn kind="ghost" disabled={busy !== null} onClick={() => { setAmount(String(Math.ceil(fees.due / 2 - fees.paid))); }}>Half the charge</Btn>
                </div>
              </>
            )}
    ...
    <>
      ...
      <div className="doc" style={{ maxWidth: 660 }}>
        ...
        <div className="tablewrap"><table style={{ minWidth: 400 }}>
          ...
          <tbody>
            <tr><td>{r.purpose}<div className="sub2 tnum">Against reference {r.reference}</div></td><td className="num tnum" style={{ fontWeight: 600 }}>{naira(r.amount)}</td></tr>
